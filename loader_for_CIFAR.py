...
# data_path = 'C:\\Users\\leoxu\\OneDrive\\Desktop\\CAS_771\\Project\\data\\cifar-10-batches-py'  # path to the data file (don't forget to download the feature data and also put the noisy label file under this folder)
...
# print("loaded noisy label")
# todo: Code your own algorithm

from torchvision.datasets import ImageFolder

def animal_dataloader():
